...
public class Person {
    ...
    public String toString() {
        return name + System.lineSeparator() +
                ...
                ((pokemonList.isEmpty()) ? "" : pokemonList.stream().map(Pokemon::toString)
                        .collect(Collectors.joining(System.lineSeparator())) + System.lineSeparator()) +
                "Parents:" + System.lineSeparator() + ((parents.isEmpty()) ? "" : parents
                .stream().map(Parent::toString)
                .collect(Collectors.joining(System.lineSeparator())) + System.lineSeparator()) +
                "Children:" + System.lineSeparator() +
                ((children.isEmpty()) ? "" : children.stream().map(Children::toString)
                        .collect(Collectors.joining(System.lineSeparator())) + System.lineSeparator());
    }
}
